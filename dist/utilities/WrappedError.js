...
var WrappedError = function (_Error) {
    ...
    function WrappedError(message, innerException) {
        _classCallCheck(this, WrappedError);

        var _this = _possibleConstructorReturn(this, (WrappedError.__proto__ || Object.getPrototypeOf(WrappedError)).call(this, message));
